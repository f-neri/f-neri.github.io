...
<i class="bi bi-geo-alt-fill"></i> San Francisco Bay Area \| <i class="bi bi-envelope-fill"></i> fneri\@buckinstitute.org

Molecular and cellular biologist working on cellular senescence and aging to develop interventions for age-related diseases
